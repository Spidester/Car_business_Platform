...
<html lang="en">
  ...
  <div class="head" style="height: 190vh;">
    ...
    <h1 style="margin:10vh 0px 0 30vw">SellAnyCar - ContactUs</h1>
  <div class="container" style="width:70vw; height 40vh;padding:5vh;">
      
  <form id="signup" action = "_dbconnect.php" method="post">
  
    <div class="form-floating mb-3">
        <input type="name" name="name" class="form-control" id="floatingInput" placeholder="John Smith">
        <label for="floatingInput">Name</label>
    </div>  
  
    <div class="form-floating mb-3">
        <input type="number" name="number" class="form-control" id="floatingInput" placeholder="0987654321"> 
        <label for="floatingInput">Number</label>
    </div>

    <div class="form-floating mb-3">
        <input type="text" name="Topic" class="form-control" id="floatingInput" placeholder="Complaints,Sughestions,Feedback"> 
    ...
    <button type="submit" class="btn btn-primary btn-sm" style="margin:2vh; margin-right:10vh;">Submit</button>
  </div>
</form>
